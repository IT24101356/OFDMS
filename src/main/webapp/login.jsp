...
<div class="bg-gray-800 p-8 rounded-xl shadow-lg w-96">
    ...
    <form action="login" method="POST">
        <div class="mb-4">
            <label for="username" class="block text-white text-lg font-semibold">Username</label>
        ...
        <div class="text-center">
            <p class="text-sm text-white">Don't have an account? <a href="signup.html" class="text-blue-500">Sign up here</a></p>
        </div>
    </form>
