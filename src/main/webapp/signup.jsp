...
<div class="bg-gray-800 text-white p-8 rounded-lg shadow-md w-full max-w-md">
    ...
    <form action="signup" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="tel" id="phone" name="phone" class="w-full p-3 border border-gray-600 rounded-md bg-gray-700 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
        </div>
        ...
        <p class="text-center mt-4">Already have an account? <a href="login.html" class="text-blue-400 hover:underline">Log in here</a></p>
    </form>
</div>
