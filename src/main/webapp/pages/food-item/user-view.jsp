...
<%
    ...
    List<Food> foodList = (ArrayList<Food>)session.getAttribute("foods");
%>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <div class="header-container">
        ...
        <nav class="nav-links">
            <div class="flex items-center space-x-4">
                <a href="<%=request.getContextPath()%>/food-view" class="text-blue-600 hover:underline">Buy Foods</a>
...
<div class="max-w-6xl mx-auto py-10 px-4">
    ...
    <div class="flex gap-4 mb-4">
        <form method="post" action="<%=request.getContextPath()%>/sort-by-price">
            <input
                    type="submit"
                    value="Price (Low to High)"
                    class="px-4 py-2 rounded-lg text-white bg-blue-600 hover:bg-blue-700 transition duration-200 cursor-pointer shadow-md"
            >
        </form>

        <form method="get" action="<%=request.getContextPath()%>/food-view">
            <input
                    type="submit"
                    value="Reset"
                    class="px-4 py-2 rounded-lg text-white bg-gray-500 hover:bg-gray-600 transition duration-200 cursor-pointer shadow-md"
            >
        </form>
    </div>
